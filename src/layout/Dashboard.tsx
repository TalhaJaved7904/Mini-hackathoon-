...
import RoomBooking from '../screens/Rooms/RoomBooking';
...
export default function Dashboard() {
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                <DrawerHeader>
                    <img height={"75%"} src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYJezZuilFBapW4nJtsXS7QrJkI6oa5_Ptpg&s" alt="" />
